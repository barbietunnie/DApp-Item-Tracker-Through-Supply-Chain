...
contract SupplyChain {
  ...
  modifier checkValue(uint _upc) {
    ...
    address payable consumerAddr = _make_payable(items[_upc].consumerID);
    consumerAddr.transfer(amountToReturn);
  }
  ...
  function buyItem(uint _upc) public payable 
    ...
    address payable farmerAddr = _make_payable(items[_upc].originFarmerID);
    farmerAddr.transfer(items[_upc].productPrice);
